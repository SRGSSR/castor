...
final class MainMutedRecipe2: NSObject, MutableReceiverStateRecipe {
...
extension MainMutedRecipe2: @preconcurrency GCKSessionManagerListener {
...
extension MainMutedRecipe2: @preconcurrency GCKRequestDelegate {
