...
final class MainVolumeRecipe2: NSObject, MutableReceiverStateRecipe {
...
extension MainVolumeRecipe2: @preconcurrency GCKSessionManagerListener {
...
extension MainVolumeRecipe2: @preconcurrency GCKRequestDelegate {
