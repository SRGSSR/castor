...
final class MultizoneMutedRecipe2: NSObject, MutableReceiverStateRecipe {
    ...
    static func status(from service: MultizoneDeviceService2) -> Bool {
...
extension MultizoneMutedRecipe2: @preconcurrency GCKSessionManagerListener {
...
extension MultizoneMutedRecipe2: @preconcurrency GCKCastDeviceStatusListener {
