...
///
///   - ``CastPlayer/returnToPreviousItem()``
///   - ``CastPlayer/advanceToNextItem()``
public enum CastNavigationMode: Equatable {
    ...
    /// Smart navigation.
    ///
    /// Makes ``CastPlayer/returnToPreviousItem()`` jump to the start position of the current item when within the first
